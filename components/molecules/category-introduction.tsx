    ...
    return (
        <Box w={'100%'} h={'100vh'}>
            <Grid templateColumns={'1fr 1fr'} h={'full'}>
                <GridItem bgImage={'https://images.unsplash.com/photo-1635846650676-55b9ba247172?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=627&q=80'} ></GridItem>
                <GridItem as={Flex} flexDir={'column'} alignItems={'center'} justifyContent={'center'} >
                    <Box maxW={'500px'}>
