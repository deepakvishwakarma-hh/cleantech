    ...
    return (
        <Box py={'6rem'}>
            ...
            <Container maxWidth={'container.xl'} >
                ...
                <Flex gap={[10, 10, 0]} overflowX={['scroll', 'scroll', 'hidden']} justifyContent={'space-between'} py={20} >
...
const Element: React.FC<Props> = ({ image, title, discription }) => {
    return (
        <Box width={'372px'}>
            <Box borderRadius={'100%'} width={'372px'} height={'372px'} bgImage={image} bgSize={'cover'}></Box>
