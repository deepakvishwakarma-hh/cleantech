        ...
        <>
            ...
            <Grid background={'#FDF9F7'} templateColumns={'1fr 3fr'} p={5} gap={5} px={10}>
                ...
                <GridItem>
                    ...
                    <Text as={'h1'} fontFamily={'heading'} fontSize={'2xl'} mb={2}>Our Products</Text>
                    <Text fontFamily={'body'}>Nutrient-rich powders to target your health goals and diet gaps as needed.</Text>
